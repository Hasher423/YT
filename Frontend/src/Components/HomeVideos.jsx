                        ...
                        {[1, 2, 3, 4, 5].map((item) => (
                            <SwiperSlide key={item}>
                                <div className='max-w-[25vw]'>
                                    <div className='w-[35vw] bg--900 h-[20vw] md:w-[] md:h md:rounded-md overflow-hidden'>
                                        <img
                                            className='w-full aspect-[15/10] object-cover object-center'
                ...
                <div className="relative px-[4vw]">
                    ...
                    >
                        {[1, 2, 3, 4, 5].map((item) => (
                            <SwiperSlide key={item}>
                                <div className='max-w-[25vw]'>
                                    <div className='w-[35vw] bg--900 h-[20vw] md:w-[35vw] md:h md:rounded-md overflow-hidden'>
                                        <img
                                            className='w-full aspect-[15/10] object-contain'
